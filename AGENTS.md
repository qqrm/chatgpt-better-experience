...
- When you change any logic, bump the extension version once per pull request in `manifest.json` (generally patch). Do not bump `package.json` for this. This keeps deployments working.
